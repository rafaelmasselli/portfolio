...
export function NotFound({ darkMod }: darkMod) {
  return (
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p
          className={`text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider ${
            darkMod ? "text-gray-100" : "text-slate-900"
          }`}
        >
          404
        </p>
        ...
        <p className={`text-lg md:text-xl lg:text-2xl ${darkMod ? "text-gray-500" : "text-gray-700"} my-12`}>
